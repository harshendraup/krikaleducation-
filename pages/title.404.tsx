...
export default function Title404() {
    return (
        <Head>
            ...
            <title>404 - Page Not Found | Krikal Education</title>
            ...
            <meta name="keywords" content="404, Page Not Found, Krikal Education, Portfolio,broken link ,missing page,link not found" />
