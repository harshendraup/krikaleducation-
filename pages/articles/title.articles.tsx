...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Krikal Education</title>
            <meta name="description" content="Explore articles authored by Krikal Education, a Full Stack Engineer and Developer." />
