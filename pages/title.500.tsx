...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Krikal Education</title>
            ...
            <meta name="keywords" content="500, internal server error, Krikal Education, Portfolio,broken link ,missing page,link not found" />
